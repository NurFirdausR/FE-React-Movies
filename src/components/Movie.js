      ...
      <div className="row m-2">
        ...
        <div className="col-6 text-end">
          {currentMovieIndex !== movies.length - 1 && (
            <button onClick={goToNextMovie} className="btn btn-md btn-primary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
      ...
      <AnimatePresence mode="wait">
        <div className="text-center">
          ...
          className="rounded"
            width="90%"
            height="400"
            src="https://www.youtube.com/embed/vCXVToxZNB4"
                ...
                {movie.image !== "" && (
                  <div className="mb-3">
                    <img
                      ...
                      srcSet={`http://image.tmdb.org/t/p/w200/${movie.image}`}
                      alt="poster"
                    />
                  </div>
                )}
              ...
              <div className="row">
                <div className="col-12 text-start ">
                  ...
                  >
                    ...
                    {movie.genres &&
                      movie.genres.map((g) => (
                        <span key={g.id} className="badge bg-secondary m-2">
                          {g.genre}
                        </span>
                      ))}
                  </motion.div>
